  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        router.refresh() // Refresh to ensure all context is updated
      } else {
      ...
      <Card className="w-full max-w-md shadow-2xl border border-border/50 bg-card/95 backdrop-blur-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <Button
            ...
            disabled={isLoading}
            variant="outline"
            className="w-full border-border/50 hover:bg-primary/5 hover:border-primary/50 transition-all duration-200"
          >
            {isLoading ? (
              <>
